    ...
    <Section id="home" className="w-full">
      <ScrollFlyIn imageUrl={royaCar} imageAlt="Roya Racing car">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <AnimatedLink className="font-heading text-md justify-center font-semibold uppercase tracking-widest text-paper">
            Welcome to Roya Racing
          </AnimatedLink>
          <h1 className="mt-2 text-6xl font-bold leading-tight text-cyan md:text-8xl">
            <AnimatedLink className="justify-center">Your Vision</AnimatedLink>
            <br />
            <AnimatedLink className="justify-center">Our Roya</AnimatedLink>
          </h1>
          <AnimatedLink className="font-heading mt-4 justify-center text-sm font-normal text-paper/60 md:text-base">
