    ...
    <Section id="press" className="relative px-6 py-24 md:px-10">
      <div className="mx-auto max-w-[1400px]">
        ...
        <RevealText
          as="h2"
          text="Recognition."
          className="max-w-2xl text-4xl font-bold leading-[1.05] text-paper md:text-5xl"
        />

        <div className="mt-14 flex flex-col items-start gap-8 border border-cyan/30 bg-cyan/[0.05] p-10 md:flex-row md:items-center md:gap-12">
